...
WiFiClient NMCU_GH_SML_3;
PubSubClient client(NMCU_GH_SML_3);
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    */
    if (client.connect("NMCU_GH_SML_3")) {
...
void loop() {
  ...
  if (now - lastMeasure > 60000) {
    ...
    client.publish("GH/SML/S3", moistLVL_msg);
  }
} 
