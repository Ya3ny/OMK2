...
WiFiClient NMCU_R1;
PubSubClient client(NMCU_R1);

const int C1 = 16;   // D0 on ESP-12E NodeMCU board
const int C2 = 5;    // D1 on ESP-12E NodeMCU board
const int C3 = 4;    // D2 on ESP-12E NodeMCU board
const int C4 = 0;    // D3 on ESP-12E NodeMCU board
const int C5 = 2;    // D4 on ESP-12E NodeMCU board
const int C6 = 14;   // D5 on ESP-12E NodeMCU board
const int C7 = 12;   // D6 on ESP-12E NodeMCU board
const int C8 = 15;   // D8 on ESP-12E NodeMCU board
...
void callback(String topic, byte* message, unsigned int length) {
  ...
  // If a message is received on the topic NMCU_R1/C#, you check if the message is either on or off. Changes R# GPIO state according to the message
  if(topic=="NMCU_R1/C1"){
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    */
    if (client.connect("NMCU_R1")) {
      Serial.println("connected");  
      // Subscribe or resubscribe to a topic
      // You can subscribe to more topics (to control more LEDs in this example)
      client.subscribe("NMCU_R1/C1");
      client.subscribe("NMCU_R1/C2");
      client.subscribe("NMCU_R1/C3");
      client.subscribe("NMCU_R1/C4");
      client.subscribe("NMCU_R1/C5");
      client.subscribe("NMCU_R1/C6");
      client.subscribe("NMCU_R1/C7");
      client.subscribe("NMCU_R1/C8");
    }
    else {
